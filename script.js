...
document.getElementById('transaction-form').onsubmit = async (e) => {
    e.preventDefault();
    try {
        // Universal DOM targeting
        const amtElem = document.getElementById('trans-amount') || document.getElementById('transactionAmount');
        const catElem = document.getElementById('trans-category') || document.getElementById('transactionCategory');
        
        // Failsafe validation
        if (!amtElem || !catElem) {
            throw new Error("Core HTML inputs missing. Ensure inputs have id='amount' and id='category'.");
        }
        ...
        const textValue = textElement ? textElement.value : "No Description";

        // Your exact original Firebase logic
