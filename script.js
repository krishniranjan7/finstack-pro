...
document.getElementById('transaction-form').onsubmit = async (e) => {
    ...
    try {
        ...
        // Safety check: Prevents crashing if the 'text' box is missing or empty
        ...
        e.target.reset();
        alert("💎 Transaction Executed and Synced successfully."); // Forces the UI to tell you it worked
        
    } catch (error) {
        // Forces the UI to tell you exactly WHY it failed
