...
function initCharts() {
    // 1. Sparkline for Investable Surplus
    const sparklineOptions = {
        series: [{ data: [10, 25, 18, 45, 30, 60, 50, 80] }], // Dummy trend data
    ...
    const sparklineChart = new ApexCharts(document.querySelector("#surplus-sparkline"), sparklineOptions);
    sparklineChart.render();

    // 2. Circular Radial Bar for ACCA Sinking Fund
    const radialOptions = {
...
// Update the Sinking Fund Sync Function to update the chart dynamically
