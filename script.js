...
document.getElementById('transaction-form').onsubmit = async (e) => {
    ...
    try {
        ...
        const amtElem = document.getElementById('amount') || document.getElementById('transactionAmount');
        const catElem = document.getElementById('category') || document.getElementById('transactionCategory');
